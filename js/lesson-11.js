    ...
    //         return `
    //             Բարև Ձեզ, Ձեզ հետ խոսում է ${app.restaurantStaff[13].customer}ը
    //             ${
    ...
    //         if (app.restaurantStaff[9].cook === true) {
    //             return `
    //             Քուրըս Արտակին ասա Մուֆլոնն ասըմ ա 6 շիշ
    //             ${app.restaurantMenu[0].item1} թո սարքի
    //              `;
    //         } else {
    //             return `
    ...
    //     povrMovr(a, b) {
    //         a == b ?
    //         app.restaurantStaff[9].cook = true :
    //         app.restaurantStaff[9].cook = false ;
